...
class ChunkExtraction:
    ...
    def chunker_function(self, filtered_questions_json, k: int = 5):
        ...
        Args:
            filtered_questions_json (str | list): List or JSON string of sub-question dicts.
        ...
        if isinstance(filtered_questions_json, str):
            ...
            try:
                ...
                return []
        elif isinstance(filtered_questions_json, list):
            # If it's already a list, use it directly
            input_list = filtered_questions_json
        else:
            print(f"❌ Error: Unexpected data type: {type(filtered_questions_json)}")
            return []
